        ...
        <section className="relative bg-gradient-to-r from-blue-100 via-white to-blue-100 w-full overflow-hidden">
            ...
            <div className="max-w-6xl mx-auto px-6 py-30 ml-4 ">
                ...
                <p className={`${manrope.className} text-lg text-gray-700 mb-8`}>
                    ...
                    <br />
                    <span className="w-4 h-3 text-black text-2xl mb-0.5 inline-block mr-3">▸</span>
                    Enabled <span className="text-gray-900 font-semibold"> LLM-powered conversational analytics (Quality-GPT)</span> using <span className="text-gray-900 font-semibold"> RAG and Text-to-SQL,</span> allowing users to access insights <br /> <span className="ml-7"> through natural language</span>
                    <br />
                    <span className="w-4 h-3 text-black text-2xl mb-0.5 inline-block mr-3">▸</span>
                    ...
                    <br />
                    <span className="w-4 h-3 text-black text-2xl mb-0.5 inline-block mr-3">▸</span>
                    Integrated <span className="text-gray-900 font-semibold"> AI orchestration frameworks (LangChain & LangGraph)</span>  with secure <span className="text-gray-900 font-semibold"> AWS-based infrastructure </span> for scalable and <br /> <span className="ml-7"> compliant operations</span>
                    <br />
                    <span className="w-4 h-3 text-black text-2xl mb-0.5 inline-block mr-3">▸</span>
                    Established a <span className="text-gray-900 font-semibold"> closed-loop intelligence system</span> enabling continuous monitoring, decision-making, and proactive quality <br /> <span className="ml-7"> management</span>
